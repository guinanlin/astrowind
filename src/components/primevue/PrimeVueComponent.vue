...
function startAnimation() {
    ...
    const intervalId = setInterval(function () {
        if (starCount < maxStars) {
            a.innerHTML += '<img src="/star-fill.svg" style="padding:0.7rem;" alt="1">';
            starCount++;
        } else {
    ...
    <div class="main-wrapper">
        <div class="main-container">
            <div class="hero-section">
                <div class="logo">
                    <img src="/primevue.svg" alt="logo" />
                    <img src="/primevue-text-white.svg" alt="logo-text" />
                </div>
            ...
            <div class="grid-section">
                ...
                <div class="card templates">
                    <img src="/primetemplates.png" alt="prime-template" class="box-image" />
                ...
                <div class="card blocks">
                    <img src="/primeblocks.png" alt="prime-template" class="box-image" />
                ...
                <div class="card primeone">
                    <img src="/primeone.png" alt="prime-template" class="box-image" />
